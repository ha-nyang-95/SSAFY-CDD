...
public class VideoServiceImpl implements VideoService {
  ...
  @Transactional
  @Override
  public VideoResponsetDto uploadVideo(MultipartFile file, Long userId) {
  ...
  public List<VideoSummaryResponseDto> findMyVideoAsc(Long userId) {
    List<Video> videoList = videoRepository.findAllByUserUserIdOrderByActivatedAtAsc(
        userId);
  ...
  public List<VideoSummaryResponseDto> findMyVideoDesc(Long userId) {
    List<Video> videoList = videoRepository.findAllByUserUserIdOrderByActivatedAtDesc(
        userId);
